 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/park/parkSpaceManager")
public class ParkSpaceManagerController extends BaseController {
	...
	@RequiresPermissions("parkspace:parkSpace:view")
	...
	public String list(ParkSpace parkSpace, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/parkspace/parkSpaceList";
	}
	...
	public String form(ParkSpace parkSpace, Model model) {
		...
		return "modules/parkspace/parkSpaceForm";
	}

	@RequiresPermissions("parkspace:parkSpace:edit")
	...
	public String save(ParkSpace parkSpace, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/park/parkSpaceManager/?repage";
	}
