...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/park/parkSpace/">停车位列表</a></li>
		<li class="active"><a href="${ctx}/park/parkSpace/form?id=${parkSpace.id}">停车位<shiro:hasPermission name="park:parkSpace:edit">${not empty parkSpace.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="park:parkSpace:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="parkSpace" action="${ctx}/park/parkSpace/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="park:parkSpace:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
